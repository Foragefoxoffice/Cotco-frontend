                ...
                <div className="hero-content">
                    ...
                    >
                        ...
                        <Paragraph className="premium-hero-subtitle">
                            Dive deep into expert analysis, cutting-edge trends, and inspiring stories
                            from thought leaders across industries
                        </Paragraph>
                    </motion.div>
                                        ...
                                        <Card
                                            ...
                                            cover={
                                                <div className="premium-image-container">
                                                    ...
                                                    />
                                                    <Tag color={getTagColor(blog.category)} className="premium-category-tag">
                                                        {blog.category}
                                                    </Tag>
                                                    {index < 3 && (
