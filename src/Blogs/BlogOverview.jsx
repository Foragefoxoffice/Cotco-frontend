...
import { Typography, Image, Row, Col, Tag, Divider, Card, Space, Avatar } from "antd";
import {
    ClockCircleOutlined,
    UserOutlined,
    ShareAltOutlined,
...
export default function BlogOverview() {
    ...
    if (!blog) return (
        <div className="premium-loading">
            ...
            <Paragraph style={{ textAlign: 'center', marginTop: 20 }}>Loading premium content...</Paragraph>
        </div>
    );
    ...
    const renderLayout = () => {
        switch (blog.layout) {
                        ...
                        <div style={{ padding: 40 }}>
                            <Space size="large" style={{ marginBottom: 24 }}>
                                ...
                                <Space>
                                    ...
                                    <Text type="secondary" strong>{blog.read_time}</Text>
                                </Space>
                            </Space>
                            ...
                            <div className="premium-metadata-item">
                                ...
                                <Text>
                                    {new Date(blog.created_at).toLocaleString([], { dateStyle: 'short', timeStyle: 'short' })}
                                </Text>
                                <Text strong> | Updated At:</Text>
                                <Text>
                                    {new Date(blog.updated_at).toLocaleString([], { dateStyle: 'short', timeStyle: 'short' })}
                                </Text>
                            </div>
            ...
            case "layout3":
                return (
                    <div className="premium-layout-3">
                        <Row gutter={[60, 40]} align="top">
                            <Col xs={24} lg={12}>
                                <div style={{ position: 'relative' }}>
                                    ...
                                    <Divider className="premium-divider" />
                                    <Space size="large" style={{ marginTop: 0 }}>
                                        <div className="premium-metadata-item">
                                            <Text strong>Created At:</Text>
                                            <Text>
                                                {new Date(blog.created_at).toLocaleString([], { dateStyle: 'short', timeStyle: 'short' })}
                        ...
                        {blog.blog_image && (
                            <div style={{
                                ...
                                <div style={{
                                    ...
                                    <Space size="small">
                                        <ClockCircleOutlined />
                                        <Text style={{ color: 'rgba(255,255,255,0.9)' }}>{blog.read_time}</Text>
                                    </Space>
                            ...
                            <Col xs={24} lg={12}>
                                <div style={{
                                    ...
                                    <div style={{
                                        ...
                                        right: 0,
                                        bottom: 0,
                                        background: 'linear-gradient(45deg, rgba(101, 126, 234, 0.1) 0%, rgba(118, 75, 162, 0.1) 100%)'
                                    }}></div>
                                </div>
                            </Col>
                            <Col xs={24} lg={12}>
