...
const Sidebar = () => {
    ...
    if (userData) {
      ...
      if (roleName === "Super Admin") {
        setPermissions({
          ...
          terms: true,
          machine: true,
          chatbot: true, // ✅ Add chatbot permission
        });
      } else {
  ...
  const t = {
    ...
    machine: isVietnamese ? "Máy Móc" : "Machine",
    chatbot: isVietnamese ? "Quản lý Chatbot" : "Chatbot", // ✅ Added
  };
  ...
  const menuItems = [
    ...
    },
    {
      ...
      subItems: [
        ...
        // ✅ NEW Chatbot page after Terms & Conditions
        { path: "/admin/knowledge", label: t.chatbot, key: "chatbot" },
      ],
    },
    {
