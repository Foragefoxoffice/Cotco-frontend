...
import { Modal, Button, Spin, Popconfirm, message } from "antd"; // 🔹 added Popconfirm + message
import MachineMainCategoryCreate from "../components/forms/createMainCategory";
import MachineMainCategoryEdit from "../components/forms/MachineMainCategoryEdit";
import { getMainCategories, deleteMainCategory } from "../Api/api"; // 🔹 import delete API

const pageContent = {
  title: { en: "Machines", vn: "Máy móc" },
  intro_text: {
    en: "Explore our range of advanced textile machinery...",
    vn: "Khám phá loạt máy móc dệt may tiên tiến...",
  },
};
...
const MachinesScreen = () => {
  ...
  return (
    <div>
      ...
      {/* Modal: Create */}
      <Modal
        title="Create Machine Main Category"
        open={isCreateModalOpen}
        footer={null}
        onCancel={() => setIsCreateModalOpen(false)}
        destroyOnClose
      >
        <MachineMainCategoryCreate onSuccess={fetchCategories} />
      </Modal>

      {/* Modal: Edit */}
      <Modal
        title="Edit Machine Main Category"
